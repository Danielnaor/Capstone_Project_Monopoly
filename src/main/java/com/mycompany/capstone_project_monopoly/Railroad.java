 ...
 */
public class Railroad extends Type implements Serializable {

    //Stores information for a given railroad
    private int cost = 200;
    private int[] rent = {25, 50, 100, 200}; //rent selected based on railroads owned
