...
public class Datafactory implements Serializable{
    ...
    /*
        builds all of the data for the games tiles based on the associated files
     */
    ...
    public void BuildProperties() {
        try {
            /*
                pulls the information for the property tiles from the files
             */
            ...
            while (file.hasNextLine()) {
                ...
                Property property = new Property(location, name, cost, rent, color, ColorName, Mortgage, isMortgaged, upgradeLevel, upgradeCost, owner);
    ...
    public void BuildTaxes() {
        try {
            /*
                pulls the information for the tax tiles from the files
             */
    ...
    public void BuildRailroads() {
        try {
            /*
                pulls the information for the railroad tiles from the files
             */
    ...
    public void BuildUtility() {
        try {
            /*
                pulls the information for the utility tiles from the files
             */
    ...
    public void BuildOther() {
        try {
            /*
                pulls the information for the other tiles from the files
             */
